...
def train():
    ### 아래에서 npy array를 받아오면 그 array를 image와 같이 생각해야 한다.
    ...
    while True:
        ...
        if sess.run(epoch) <= PRETRAIN_EPOCH:
            ...
            for i in tqdm.tqdm(range(step_num)):
                ...
                #print(f'points_batch : {points_batch}, mask_batch : {mask_batch}')
                ### 여기 수정 잠시 대기 0429 13:40
                '''
        ...
        # Discrimitation
            ...
            for i in tqdm.tqdm(range(step_num)):
                ...
                for i in range(BATCH_SIZE):
                    x1, y1, x2, y2 = mask_image(x_batch[i][:,:,:])
...
def mask_image(x_batch):
	...
	return startX, (startY+endY)*19//40, (endX+10), endY+10
