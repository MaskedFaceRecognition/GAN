# 최근 백업 : 20210514
# get_point에서 model을 불러낼때마다 시간이 오래 걸린다. 그래서 get_point 바깥에서 model을 불러내게 바꿔줬다. 
### 은 내가 수정한 것
## 은 원래 있던거
    ...
    while True:
        ...
        if sess.run(epoch) <= PRETRAIN_EPOCH:
            ...
            for i in tqdm.tqdm(range(step_num)):
                ...
                points_batch, mask_batch = get_points(x_batch,net,args,get_point_model)
        ...
        # Discrimitation
            ...
            for i in tqdm.tqdm(range(step_num)):
                ...
                points_batch, mask_batch = points_batch[i]
